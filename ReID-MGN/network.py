...
class MGN(nn.Module):
    ...
    def forward(self, x):
        ...
        print('p1: {}'.format(p1.shape))
        print('p2: {}'.format(p2.shape))
        print('p3: {}'.format(p3.shape))
        # p1: torch.Size([16, 2048, 12, 4])
        # p2: torch.Size([16, 2048, 24, 8])
        # p3: torch.Size([16, 2048, 24, 8])
        ...
        print(zp2.shape)
        print(zp3.shape)
        # torch.Size([16, 2048, 2, 1])
        # torch.Size([16, 2048, 3, 1])
        z0_p3 = zp3[:, :, 0:1, :]
        z1_p3 = zp3[:, :, 1:2, :]
        z2_p3 = zp3[:, :, 2:3, :]
